...
class Header extends Component {
  renderUserInfoSection() {
    if (!this.props.authed) {
      ...
      return (
        <Fragment> <Link className="nav-link" to="/account"> Witaj {this.props.userName}
        </Link>
          <li className="nav-item nav-link" style={{ cursor: "pointer" }} onClick={() => {
        ...
        <header className="header-section">
          <div className="container">
            ...
            <Navbar className="navbar navbar-expand-lg navbar-light">
              ...
              <Navbar.Collapse className="collapse navbar-collapse col-4 justify-content-end" id="navbarNav">
                <Nav>
                  <NavItem>
                    <Link className="nav-link" to="/events/list"> <img src={ExploreIcon} alt="explore"/> </Link>
                  </NavItem>
                  <NavItem>
